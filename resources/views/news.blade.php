          ...
          <div class="row">
            ...
            <div class="row" class="form-control">
              <section class="col-lg-12 connectedSortable">
                    <form action="/createnew" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">news description</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                name="description">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail12" class="form-label">news Image</label>
